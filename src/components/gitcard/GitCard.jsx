      ...
      <div className="flex w-full flex-col justify-between items-center gap-4 ">
        {components.map((item, index) => (
          ...
          item.gits.map((git, gitIndex) => (
            ...
            <a href={git.links}   target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-zinc-600 rounded-full hover:bg-zinc-800">
        view project
