...
function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About | Mohit Mahmud - Full Stack Web Developer</title>
        <meta
          name="description"
          content="Learn more about Mohit Mahmud – a passionate full-stack React & Node.js developer building modern web experiences."
        />
      </Helmet>
          ...
          >
            ...
            >
              <section className="w-full px-6 sm:px-16 py-16 flex flex-col   ">
                <h1 className="f1  text-5xl md:text-4xl mb-8 cursor-default text-green-400  sm:text-end text-center ">
                  Who I Am
                </h1>
                <p className="text-lg md:text-6xl sm:text-start text-center   cursor-default">
                  ...
                  <span className=" text-green-800">Node.js</span>. I enjoy
                  building responsive, user-friendly applications and solving
                  complex problems.
                </p>
              </section>
            </SwiperSlide>
            ...
            >
              <section className="w-full px-6 sm:px-16 py-16 flex flex-col   ">
                <h1 className="f1  text-5xl md:text-4xl mb-8 cursor-default text-fuchsia-400 sm:text-end  text-center  ">
                  Get In Touch
                </h1>
                <p className="text-lg md:text-6xl sm:text-start text-center    cursor-default">
